...
public class MapHandler {
    ...
    public enum Maps {
        ...
        CRIMSON(0.5f, 790, 681, 752, 1070, 750, 1083, new ResourceLocation("skyblockhud", "maps/crimson.png"), Collections.emptyList()),
        ...
        THEEND(1f, 336, 281, 787, 403, 788, 406, new ResourceLocation("skyblockhud", "maps/end.png"), Collections.emptyList());
